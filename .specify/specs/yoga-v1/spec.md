...
**FR-008**: Cancellation >24hrs before class: immediate. Cancellation <24hrs: request flow with instructor acceptance or alternative slot proposal.
...
**FR-013**: All notifications (booking events, reminders, cancellations) sent via email (Resend) + SMS (Twilio).
...
| notifications_log | id, booking_id, recipient_id, channel, type, sent_at |
